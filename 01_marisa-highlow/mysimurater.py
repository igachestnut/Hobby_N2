""" ####################################################################
霧雨魔理沙を助けるゲーム のシミュレーター

[元ゲーム](https://sairoutine.github.io/MARISA-HighLow/public/)

# 使いかた
- `main`を実行すると、デスゲームのシミュレーションが行える。
- `simurate_probability`は、デスゲームを10万回繰り返し、成功確率の分布をtxtに出力する。
- `myCards`はデスゲーム中のカードの残り枚数を保持するクラス。外部から呼び出し可能。
