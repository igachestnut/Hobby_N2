...
def main() :
    #作りたいファイル名指定
    mypyName = ["A","B","C","C2","D","D2","E","F","G"]
    anspyName = ["C-Ans","D-Ans","E-Ans","F-Ans","G-Ans"]
    ...
    makefile(Newfilename_ans, template_text_of_ans())
    return
